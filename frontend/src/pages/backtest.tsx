                ...
                <TableBody>
                  {list.map(b => (
                    <TableRow key={b.id}>
                      ...
                      <TableCell><Button size="sm" variant="ghost" onClick={() => load(b.id)}>View</Button></TableCell>
                    </TableRow>
                  ))}
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={run} className="space-y-3">
              ...
              <Field label="Symbol"><input className="w-full rounded-md border px-3 py-2 font-mono text-sm uppercase" value={symbol} onChange={e => setSymbol(e.target.value)} required /></Field>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Field label="From"><input className="w-full rounded-md border px-3 py-2 text-sm" type="datetime-local" value={from} onChange={e => setFrom(e.target.value)} required /></Field>
                <Field label="To"><input className="w-full rounded-md border px-3 py-2 text-sm" type="datetime-local" value={to} onChange={e => setTo(e.target.value)} required /></Field>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <Field label="Initial capital"><input className="w-full rounded-md border px-3 py-2 text-sm" type="number" step="100" value={capital} onChange={e => setCapital(e.target.value)} required /></Field>
                <Field label="Commission %"><input className="w-full rounded-md border px-3 py-2 text-sm" type="number" step="0.01" value={fee} onChange={e => setFee(e.target.value)} required /></Field>
              </div>
